...
@section('title', 'Editar Comprobante SUNAT - Hotel Jardín del Sol')
...
<head>
    ...
    <style>
        ...
        .current-file-alert {
            background: linear-gradient(135deg, rgba(233, 134, 114, 0.1), rgba(233, 134, 114, 0.05));
            border: 2px solid var(--tertiary-color);
            border-radius: 0.75rem;
            padding: 1rem;
            margin-bottom: 1rem;
            ...
            <div class="page-header">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="floating-icon mr-4" style="background: white; color: var(--primary-color);">
